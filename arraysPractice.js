...
const finder = (arr) => {
    ...
    let finder = arr.indexOf(randomNumber);
    if(finder > -1) {
        return true;
    }
    else {
...
const fired = () => {
  for (var i = 0; i < devMountainEmployees.length; i++) {
    if (devMountainEmployees[i] === cahlan) {
      return devMountainEmployees.splice(i, 1);
    }
  }
}
fired();
...
//Create an empty array called users.
  ...
  //Code Here
let users = []
users.push({name: "Bruno", email: "dipsnatchy26@gmail.com", password: "Not for you", username: "Snatchy"},
  {name: "John", email: "ihihihih@gmail.com", password: "010101", username: "Joh"},
  {name: "Bryan", email: "dfgdfgd@gmail.com", password: "1234", username: "Bry"}
  );
